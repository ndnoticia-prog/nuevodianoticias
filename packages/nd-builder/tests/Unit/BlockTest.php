...
final class BlockTest extends TestCase {
	...
	public function test_attribute_returns_default_when_missing(): void {
		$block = new Block( 'hero', 'hero-1', array( 'title' => 'Titular' ) );
	...
	public function test_with_attributes_merges_without_mutating_original(): void {
		$original = new Block( 'hero', 'hero-1', array( 'title' => 'Titular' ) );
		$modified = $original->withAttributes( array( 'subtitle' => 'Bajada' ) );

		self::assertSame( array( 'title' => 'Titular' ), $original->attributes );
		self::assertSame(
			array(
				'title'    => 'Titular',
				'subtitle' => 'Bajada',
