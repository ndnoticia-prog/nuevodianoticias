...
final class ThemeServiceProvider extends ServiceProvider {
	...
	public function enqueueAssets(): void {
		...
		if ( file_exists( $cssPath ) ) {
			wp_enqueue_style( 'nd-theme', ND_THEME_URI . '/dist/app.css', array(), (string) filemtime( $cssPath ) );
		}

		if ( file_exists( $jsPath ) ) {
			wp_enqueue_script( 'nd-theme', ND_THEME_URI . '/dist/app.js', array(), (string) filemtime( $jsPath ), true );
		}
	}
}
