...
/**
 * Bootstrap de PHPUnit para las pruebas de integración de nd-workflow contra
 * una base de datos MySQL real: nd-workflow es un paquete "librería" sin
 ...
 * nd-core.php basta para que también arranque WorkflowServiceProvider. Mismo
