...
final class ArrTest extends TestCase {
	...
	public function test_get_supports_dot_notation(): void {
		$array = array( 'cache' => array( 'redis' => array( 'host' => '127.0.0.1' ) ) );
	...
	public function test_set_creates_nested_structure(): void {
		$array = Arr::set( array(), 'cache.redis.host', '127.0.0.1' );

		self::assertSame( array( 'cache' => array( 'redis' => array( 'host' => '127.0.0.1' ) ) ), $array );
	}

	public function test_has(): void {
		$array = array( 'a' => array( 'b' => null ) );
	...
	public function test_only_and_except(): void {
		...
		self::assertSame(
			...
			Arr::only( $array, array( 'a', 'c' ) )
		);
		self::assertSame( array( 'b' => 2 ), Arr::except( $array, array( 'a', 'c' ) ) );
	}

	public function test_flatten(): void {
		$array = array( 'a' => array( 1, 2, array( 'b' => 3 ) ) );

		self::assertSame( array( 1, 2, 3 ), Arr::flatten( $array ) );
	}
}
