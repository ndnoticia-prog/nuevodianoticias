...
final class SettingsRepositoryTest extends BrainMonkeyTestCase {
	...
	public function test_has_returns_false_when_option_absent(): void {
		// get_option() real de WordPress devuelve el $default recibido cuando
		// la opción no existe; simularlo con un null fijo no representa ese
		// comportamiento (y hacía que has() interpretara "ausente" como
