...
final class Client {
	...
	public function send( Request $request ): Response {
		...
		if ( is_wp_error( $response ) ) {
			return new Response( 0, array(), '', true, $response->get_error_message() );
		}
	 ...
	 * @param array<string, string> $headers
	 */
	public function postJson( string $url, array $data = array(), array $headers = array() ): Response {
	 ...
	 * @param array<string, string> $headers
	 */
	public function putJson( string $url, array $data = array(), array $headers = array() ): Response {
	 ...
	 * @param array<string, string> $headers
	 */
	public function delete( string $url, array $headers = array() ): Response {
