...
final class Router
{
     ...
     */
    public function get(string $namespace, string $path, callable $handler, ?callable $permission = null, array $args = []): Route
    {
     ...
     * @param array<string, mixed> $args
     */
    public function post(string $namespace, string $path, callable $handler, ?callable $permission = null, array $args = []): Route
    {
     ...
     * @param array<string, mixed> $args
     */
    public function put(string $namespace, string $path, callable $handler, ?callable $permission = null, array $args = []): Route
    {
     ...
     * @param array<string, mixed> $args
     */
    public function patch(string $namespace, string $path, callable $handler, ?callable $permission = null, array $args = []): Route
    {
     ...
     * @param array<string, mixed> $args
     */
    public function delete(string $namespace, string $path, callable $handler, ?callable $permission = null, array $args = []): Route
    {
