...
final class SearchIndexRepository {
	...
	public function delete( int $postId ): bool {
		return (bool) $this->db->delete( $this->db->table( self::TABLE ), array( 'post_id' => $postId ) );
	}
	...
	private function exists( int $postId ): bool {
		...
		return $this->db->selectOne( "SELECT post_id FROM {$table} WHERE post_id = %d", array( $postId ) ) !== null;
	}
}
