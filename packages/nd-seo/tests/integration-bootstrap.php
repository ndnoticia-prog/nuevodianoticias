...
/**
 * Bootstrap de PHPUnit para las pruebas de integración de nd-seo contra una
 * base de datos MySQL real: nd-seo es un paquete "librería" sin archivo de
 * plugin propio (se activa por completo dentro de nd-core, ver
 * NDCore\Application::resolveProviderClasses() y su comprobación
 * class_exists(SeoServiceProvider::class)), así que arrancar nd-core.php
 * basta para que también arranque SeoServiceProvider. Mismo patrón que
 * packages/nd-search/tests/integration-bootstrap.php — ver
