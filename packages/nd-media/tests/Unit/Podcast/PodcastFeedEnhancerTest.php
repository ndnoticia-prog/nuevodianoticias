...
final class PodcastFeedEnhancerTest extends BrainMonkeyTestCase
{
    ...
    public function test_add_enclosure_prints_enclosure_tag_when_audio_is_set(): void
    {
        ...
        Functions\expect('get_post_meta')->with(42, '_nd_podcast_audio_url', true)->andReturn('https://example.test/episodio.mp3');
        Functions\expect('get_post_meta')->with(42, '_nd_podcast_audio_length', true)->andReturn('123456');
