...
/**
 * Bootstrap de PHPUnit para las pruebas de integración de nd-analytics
 * contra una base de datos MySQL real: nd-analytics es un paquete
 * "librería" sin archivo de plugin propio (se activa por completo dentro
 * de nd-core, ver NDCore\Application::resolveProviderClasses()), así que
 * arrancar nd-core.php basta para que también arranque
 * AnalyticsServiceProvider. Mismo patrón que
 * packages/nd-core/tests/integration-bootstrap.php — ver
