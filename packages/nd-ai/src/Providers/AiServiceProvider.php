...
final class AiServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->container->singleton(OpenAiProvider::class, function () use ($config): OpenAiProvider {
        ...
        $this->container->singleton(ClaudeProvider::class, function () use ($config): ClaudeProvider {
            /** @var ApiKeyStore $keys */
            $keys = $this->container->make(ApiKeyStore::class);
        ...
        $this->container->singleton(GeminiProvider::class, function () use ($config): GeminiProvider {
            /** @var ApiKeyStore $keys */
            $keys = $this->container->make(ApiKeyStore::class);
        ...
        $this->container->singleton(DeepSeekProvider::class, function () use ($config): DeepSeekProvider {
            /** @var ApiKeyStore $keys */
            $keys = $this->container->make(ApiKeyStore::class);
        ...
        $this->container->singleton(LocalLlmProvider::class, function () use ($config): LocalLlmProvider {
        ...
        $this->container->singleton(AiManager::class, function () use ($config): AiManager {
            return new AiManager(
                providers: [
                    $this->container->make(OpenAiProvider::class),
                    $this->container->make(ClaudeProvider::class),
                    $this->container->make(GeminiProvider::class),
                    $this->container->make(DeepSeekProvider::class),
                    $this->container->make(LocalLlmProvider::class),
                ],
