...
/**
 * Bootstrap de PHPUnit para las pruebas de integración de nd-ads contra
 * una base de datos MySQL real: nd-ads es un paquete "librería" sin
 ...
 * nd-core.php basta para que también arranque AdsServiceProvider. Mismo
