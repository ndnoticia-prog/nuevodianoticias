...
final class AdRendererTest extends BrainMonkeyTestCase
{
    ...
    {
        $html = (new AdRenderer())->render($this->campaign(CampaignType::AdSense, [
    ...
    {
        self::assertSame('', (new AdRenderer())->render($this->campaign(CampaignType::AdSense, [
            'adsense_client' => 'ca-pub-123',
        ])));
    }
    ...
    {
        $html = (new AdRenderer())->render($this->campaign(CampaignType::GoogleAdManager, [
    ...
    {
        $html = (new AdRenderer())->render($this->campaign(CampaignType::Html, [
    ...
    {
        $html = (new AdRenderer())->render($this->campaign(CampaignType::Image, [
    ...
    {
        $html = (new AdRenderer())->render($this->campaign(CampaignType::Video, [
    ...
    {
        $html = (new AdRenderer())->render($this->campaign(CampaignType::Sponsored, [
    ...
    {
        self::assertSame('', (new AdRenderer())->render($this->campaign(CampaignType::Video, [])));
    }
}
